...
#define LOW_PRECISION`),e}function DS(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===vu?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===ag?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===$n&&(e="SHADOWMAP_TYPE_VSM"),e}function IS(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case rs:case os:e="ENVMAP_TYPE_CUBE";break;case qr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function NS(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case os:e="ENVMAP_MODE_REFRACTION";break}return e}function US(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case xu:e="ENVMAP_BLENDING_MULTIPLY";break;case Ag:e="ENVMAP_BLENDING_MIX";break;case wg:e="ENVMAP_BLENDING_ADD";break}return e}function FS(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function OS(s,e,t,n){const i=s.getContext(),r=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=DS(t),c=IS(t),h=NS(t),u=US(t),d=FS(t),f=TS(t),_=bS(r),g=i.createProgram();let m,p,T=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+p);const E=T+m+o,x=T+p+a,w=kc(i,i.VERTEX_SHADER,E),C=kc(i,i.FRAGMENT_SHADER,x);i.attachShader(g,w),i.attachShader(g,C),t.index0AttributeName!==void 0?i.bindAttribLocation(g,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(g,0,"position"),i.linkProgram(g);function R(b){if(s.debug.checkShaderErrors){const q=i.getProgramInfoLog(g)||"",j=i.getShaderInfoLog(w)||"",B=i.getShaderInfoLog(C)||"",V=q.trim(),F=j.trim(),X=B.trim();let I=!0,ee=!0;if(i.getProgramParameter(g,i.LINK_STATUS)===!1)if(I=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,g,w,C);else{const te=Vc(i,w,"vertex"),he=Vc(i,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(g,i.VALIDATE_STATUS)+`
