...
`)+`
`+p);const E=T+m+o,x=T+p+a,R=kc(i,i.VERTEX_SHADER,E),P=kc(i,i.FRAGMENT_SHADER,x);i.attachShader(g,R),i.attachShader(g,P),t.index0AttributeName!==void 0?i.bindAttribLocation(g,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(g,0,"position"),i.linkProgram(g);function w(b){if(s.debug.checkShaderErrors){const q=i.getProgramInfoLog(g)||"",j=i.getShaderInfoLog(R)||"",B=i.getShaderInfoLog(P)||"",V=q.trim(),F=j.trim(),X=B.trim();let D=!0,ee=!0;if(i.getProgramParameter(g,i.LINK_STATUS)===!1)if(D=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,g,R,P);else{const te=Vc(i,R,"vertex"),he=Vc(i,P,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(g,i.VALIDATE_STATUS)+`
